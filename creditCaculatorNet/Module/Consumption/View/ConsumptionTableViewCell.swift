...
class ConsumptionTableViewCell: SNBaseTableViewCell {
...
extension ConsumptionTableViewCell  {
    ...
    ///   - billDate: 账单日
    ///   - billDateT: 账单日title
    ///   - reimbursementDate: 还款日
    ///   - reimbursementT: 还款日title
    ///   - totalValue: 总额度
    ///   - totalValueT: 总额度title
    ///   - status: 状态信息
    ///   - temporaryT: 可用额度title
    ///   - temporaryValue: 可用额度
    func set(bankName: String, cardNo: String, billDate: String, billDateT: String = "账单日", reimbursementDate: String, reimbursementT: String = "还款日", totalValue: String, totalValueT: String = "总额度", status: String, temporaryT: String = "可用额度", temporaryValue: String) {
